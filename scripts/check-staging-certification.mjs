...
const required={
  ...
  'tests/staging/helpers.mjs':['STAGING_QA_PLAYER_IDENTIFIER','STAGING_QA_OTP_CODE','signInFromAccount','assertNoHorizontalOverflow'],
  ...
  'tests/staging/premium-payments.spec.mjs':['fixed-duration billing semantics','pending server transaction','cannot self-activate'],
